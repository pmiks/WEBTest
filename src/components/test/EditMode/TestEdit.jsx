...
const TestEdit=({tp,setTP,saveTestCoverImg,deleteTestCoverImg})=>{
  ...
  return tp?<div className="testedit">
      <div><LoadImage zoomer="true" id={"test"+tp.id} width="100px" height="100px" img={tp.coverimg} onLoad={(e)=>{saveTCI(e,tp.id)}} onDel={()=>{deleteTestCoverImg(tp.id)}}/>
            Создан: {tp.datecreate} Изменен: {tp.dateedit}
      </div>
