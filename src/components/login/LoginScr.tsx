...
const imgStyle:CSSProperties={
  ...
  return <div className="Login">
    ...
    {me.isAuth&&
      ...
      <div><div >{/*me.last_name*/} {me.first_name}</div><div><img src={String(me.photo)}/></div></div>
      </NavLink>
    </div>}
    ...
    <a href="https://oauth.vk.com/authorize?client_id=7444329&display=page&redirect_uri=http://api.electricalab.ru/auth/vk.php&response_type=code&v=5.52"><div>
      <img style={imgStyle} src={logovk}/></div></a>
      <div><img style={imgStyle} src={logofb}/></div>
      <div><img style={imgStyle} src={logogoogle}/></div>
      </div>}
